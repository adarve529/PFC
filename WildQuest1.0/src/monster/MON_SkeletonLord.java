...
public class MON_SkeletonLord extends Entity{
	...
	public void setDialogue() {
		...
		dialogues[0][0] = "Veo que has llegado hasta aquí.";
		dialogues[0][1] = "Si quieres salir de aquí tendrás que matarme,\n y te aseguro que no te será fácil.";
		dialogues[0][2] = "¡Ven aquí!!!!!";
	}
