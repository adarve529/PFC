...
public class EntityGenerator {
	...
	public Entity getObject(String itemName) {
		...
		case OBJ_Cottage.objName: obj = new OBJ_Cottage(gp); break;
		case OBJ_Cottage2.objName: obj = new OBJ_Cottage2(gp); break;
		...
		case OBJ_Fountain.objName: obj = new OBJ_Fountain(gp); break;
		...
		case OBJ_StreetLight.objName: obj = new OBJ_StreetLight(gp); break;
		case OBJ_Sword_Normal.objName: obj = new OBJ_Sword_Normal(gp); break;
		case OBJ_Tent.objName: obj = new OBJ_Tent(gp); break;
		case OBJ_TownHall.objName: obj = new OBJ_TownHall(gp); break;
