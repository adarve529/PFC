...
import object.OBJ_Cottage;
import object.OBJ_Cottage2;
...
import object.OBJ_LargeCottage;
import object.OBJ_ManaCrystal;
import object.OBJ_Pickaxe;
import object.OBJ_Potion_Red;
import object.OBJ_Shield_Blue;
import object.OBJ_Stall;
import object.OBJ_StreetLight;
import object.OBJ_Tent;
import object.OBJ_TownHall;
...
public class AssetSetter {
	...
	// Creacion y colocación en el mapa de objetos
...
//		i++;
		...
		gp.obj[mapNum][i] = new OBJ_Cottage(gp);
		gp.obj[mapNum][i].worldX = gp.tileSize*31;
		gp.obj[mapNum][i].worldY = gp.tileSize*30;
		i++;
		
		gp.obj[mapNum][i] = new OBJ_Cottage2(gp);
		gp.obj[mapNum][i].worldX = gp.tileSize*16;
		gp.obj[mapNum][i].worldY = gp.tileSize*30;
		i++;
		
		gp.obj[mapNum][i] = new OBJ_TownHall(gp);
		gp.obj[mapNum][i].worldX = gp.tileSize*23;
		gp.obj[mapNum][i].worldY = gp.tileSize*28;
		i++;
		
		gp.obj[mapNum][i] = new OBJ_StreetLight(gp);
		gp.obj[mapNum][i].worldX = gp.tileSize*14;
		...
		gp.obj[mapNum][i] = new OBJ_Stall(gp);
		gp.obj[mapNum][i].worldX = gp.tileSize*16;
...
//		gp.obj[mapNum][i] = new OBJ_LargeCottage(gp);
//		gp.obj[mapNum][i].worldX = gp.tileSize*21;
...
//		gp.iTile[mapNum][i] = new IT_DryTree(gp, 29, 31); i++;
		...
		gp.iTile[mapNum][i] = new IT_DryTree(gp, 15, 6); i++;
		gp.iTile[mapNum][i] = new IT_DryTree(gp, 16, 6); i++;
		gp.iTile[mapNum][i] = new IT_DryTree(gp, 17, 6); i++;
		gp.iTile[mapNum][i] = new IT_DryTree(gp, 18, 6); i++;
		gp.iTile[mapNum][i] = new IT_DryTree(gp, 19, 6); i++;
