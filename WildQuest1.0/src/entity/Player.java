...
public class Player extends Entity {
	...
	public Player(GamePanel gp, KeyHandler keyH) {
		...
		// SOLID AREA
		solidArea = new Rectangle();// Instanciamos aquí el rectángulo para la zona de colisión del sprite del Player
		solidArea.x = 8;
		solidArea.y = 16;
	...
	public void setDefaultValues() {
		...
		// PLAYER STATUS
		level = 1;
		maxLife = 10; // 6 significa 6 mitades, así que serían 3 vidas, 6 golpes
		life = maxLife;
		maxMana = 4;
		mana = maxMana;
		ammo = 10;// Testeando
		strength = 2;// The more strhenght he has, the more damage he gives
		...
		// projectile = new OBJ_Rock(gp);// testing
		attack = getAttack();// The total attack value is decided by strenght and weapon
		defense = getDefense();// The total defense values is decides by dextirity and shield
	...
	public void getImage() {
		...
		stand = setup("/player/chef_stand", gp.tileSize, gp.tileSize);
	...
	public void update() {
       ...
       if(knockBack == true) {
		...
		// Con esta línea hacemos que los sprites no cambien si no pulsamos nada
			...
			if (keyH.upPressed) {// Movemos al personaje. Al pulsar arriba, la coordenada y cambia en relación a la velocidad
				direction = "up";
			}
		...
		if (gp.keyH.shotKeyPressed && !projectile.alive && shotAvailableCounter == 30
				&& projectile.haveResource(this)) {// Con la segunda condición evitamos que se puedan disparar varios projectiles a la vez
